...
public class MailIndexer {
    public static void index(String emlPath) throws MessagingException, IOException {
        ...
        if (listOfFiles!=null) {
            for (File file : listOfFiles) {
                if (file.isFile()) {
                    ...
                    parseEml(emlPath, file);
                }
            }
        }
    }
    private static void parseEml(String path, File emlFile) throws IOException, MessagingException {
